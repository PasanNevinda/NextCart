  ...
  return (
    <div className="text-left">
      <h1 className="mb-8 flex items-center gap-2 text-3xl font-bold text-base-content">
        <ShoppingCartIcon className="size-8 text-primary" aria-hidden="true" />
        Cart
      </h1>
      ...
      {items.length === 0 ? (
        ...
        <PageError message="Could not load the cart details. Refresh the page or try again shortly" />
      ) : (
